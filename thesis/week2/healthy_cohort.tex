...
do something that is rarely done. To my understanding, these participants were imaged as part of a
research protocol rather than because anyone suspected disease in them, so their trees form the
distribution of a population rather than of patients. A substantial number have also been scanned a
second time, which lets us watch how a tree changes, or does not, in people in whom no disease was
found at the first scan. Where participants have had events in the meantime, it will be interesting
to see how their arteries changed in the second scan, and whether the trees that were healthy at the
first scan and later had an event share features that the trees without events do not.

Open questions remain about how to define the cohort: some participants will have CAD, so should
those be excluded or not, and are ImageCAS participants with no plaque then ``healthy''? These are
questions for later, depending on the direction the thesis takes.
